...
#> [20:36:45] Initializing Cerebro object...
#> [20:36:45] Adding expression data (embedded)...
#> [20:36:45] Collecting available meta data...
#> [20:36:45] Extracting all meta data columns...
#> [20:36:45] Extracting dimensional reductions...
#> [20:36:45] Will export the following dimensional reductions: umap
#> [20:36:45] Extracting marker genes table...
#> [20:36:45] No trajectories to extract...
#> [20:36:45] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.5
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-07-03
#> number of cells: 80
#> number of genes: 230
...
#> extra material:
#> Immune repertoire:
#> [20:36:45] Saving Cerebro object to: /tmp/nix-shell-4578-4149238183/RtmpJLenAq/pbmc_Seurat.crb
#> [20:36:45] Done!
```
