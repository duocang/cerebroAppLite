...
#> [13:09:12] Adding expression data (embedded)...
...
#> [13:09:12] Extracting marker genes table...
#> [13:09:12] No trajectories to extract...
#> [13:09:12] Checking for spatial data...
...
#> Immune repertoire:
#> Spatial data:
#> [13:09:12] Saving Cerebro object to: /tmp/nix-shell-4340-2787629888/Rtmp1w1T9w/pbmc_Seurat.crb
#> [13:09:12] Done!
```
